...
def review_edit(request, book_pk, review_pk = None):
    ...
    return render(request, 'instance-form.html', {'form': form, 'instance': review, 'model_type': "Review", 'related_model_type': 'Book', 'related_instance':book})
...
def book_media(request, pk):
    ...
    return render(request, "instance-form.html", {"instance": book, "form": form, "model_type": "Book", "is_file_upload": True})